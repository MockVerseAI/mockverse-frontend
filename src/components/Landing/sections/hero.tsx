...
const Hero = () => {
  return (
    <div className="relative flex w-full flex-col items-center justify-center py-20">
      <div className="absolute left-1/2 top-0 -z-10 flex size-40 -translate-x-1/2 rounded-full bg-blue-500 blur-[10rem] lg:hidden"></div>
        ...
        <div className="flex flex-col items-center justify-center gap-y-4 bg-background/0 text-center">
          ...
          <Container delay={0.3} className="relative">
            <div className="relative mx-auto mt-10 max-w-6xl rounded-xl border border-border p-2 backdrop-blur-lg lg:rounded-[32px]">
              <div className="absolute inset-0 left-1/2 top-1/8 -z-10 h-1/4 w-1/2 -translate-x-1/2 -translate-y-1/2 animate-image-glow bg-gradient-to-r from-sky-500 to-blue-600 blur-[4rem] lg:w-3/4 lg:blur-[10rem]"></div>
              <div className="absolute inset-0 -top-1/8 left-1/2 -z-20 hidden h-1/4 w-1/4 -translate-x-1/2 -translate-y-1/2 animate-image-glow bg-blue-600 blur-[10rem] lg:block"></div>
            ...
            <div className="absolute inset-x-0 bottom-0 h-1/2 w-full bg-gradient-to-t from-background to-transparent"></div>
          </Container>
        </div>
      </div>
    </div>
